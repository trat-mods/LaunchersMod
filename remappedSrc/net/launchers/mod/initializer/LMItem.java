...
public final class LMItem {
    public static void initialize() {
        var exLauncher = Registry.register(Registries.ITEM, ExtremeLauncherBlock.ID, new BlockItem(EXTREME_LAUNCHER_BLOCK, new Item.Settings()));
        var powLauncher = Registry.register(Registries.ITEM, PoweredLauncherBlock.ID, new BlockItem(POWERED_LAUNCHER_BLOCK, new Item.Settings()));
        var launcher = Registry.register(Registries.ITEM, LauncherBlock.ID, new BlockItem(LAUNCHER_BLOCK, new Item.Settings()));
