...
public final class LMEntities
{
    ...
    public static void initialize()
    {
        ...
        PW_LAUNCHER_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, LMLoader.MOD_ID + ":" + PoweredLauncherBlock.ID.getPath(), BlockEntityType.Builder.create(PoweredLauncherBlockEntity::new, POWERED_LAUNCHER_BLOCK).build(null));
        EX_LAUNCHER_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, LMLoader.MOD_ID + ":" + ExtremeLauncherBlock.ID.getPath(), BlockEntityType.Builder.create(ExtremeLauncherBlockEntity::new, EXTREME_LAUNCHER_BLOCK).build(null));
    }
}
