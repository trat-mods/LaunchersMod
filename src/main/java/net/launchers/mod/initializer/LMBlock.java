...
public final class LMBlock {
    ...
    public static final UltimateLauncherBlock ULTIMATE_LAUNCHER_BLOCK = new UltimateLauncherBlock();
    ...
    public static void initialize() {
        ...
        Registry.register(Registries.BLOCK, UltimateLauncherBlock.ID, ULTIMATE_LAUNCHER_BLOCK);
    }
}
