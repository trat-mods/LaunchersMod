...
import static net.launchers.mod.loader.LaunchersLoader.*;
...
public class ClientLoader implements ClientModInitializer
{
    ...
    public void onInitializeClient()
    {
        ...
        ClientSidePacketRegistry.INSTANCE.register(CustomPacket.PACKET_ID, (ctx, buf) -> UnboundedPlayerVelocityS2CPacket.read(buf).onReceive(ctx));
    }
}
